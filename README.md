...
![Overview](https://github.com/OpenBlockMesh/OBM-Fabric/blob/master/overview.jpg)
...
Get the Kubernetes Cluster Version and ensure your kubectl is at the same version.

Install kubectl as per this site : 
* Installing and Setting up kubectl
* http://kubernetes.io/docs/user-guide/prereqs/

Once kubectl is provisioned you should have similar output as shown below for your nodes.
...
* /usr/bin/docker daemon --api-cors-header="*" -H tcp://0.0.0.0:2375 -H unix:///var/run/docker.sock
